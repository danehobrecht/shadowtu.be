...
ShadowTube does not store the text from comment data, and intentionally doesn't have the ability to. Comment UUIDs are used to detect prescence in corresponding videos. Individual verification is firmly encouraged.
