...
ShadowTube does not relay personal data of any kind, nor does it have the ability to. Any data given by the user through consent is ephemeral. Individual verification is firmly encouraged. For the time being, this program is strictly bash.
